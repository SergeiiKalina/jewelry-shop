...
</div>`}commentButoon.addEventListener("click",e=>{e.preventDefault();var e=form.querySelector(".comment_text").value,t=form.querySelector(".comment_email").value,r=form.querySelector(".comment_name").value,a=(new Date).getDate();let c=(new Date).getMonth();var i=(new Date).getFullYear(),l=document.getElementById("checkbox"),n=document.querySelector(".tab3_review"),n=(ratValue(n),value/.05);console.log(value),l.checked?(""==r&&alert("Enter Name"),validateEmail(t),validateEmail(t)?(form.querySelector(".comment_email").style.borderColor="red",11==(c=10==(c=9==(c=8==(c=7==(c=6==(c=5==(c=4==(c=3==(c=2==(c=1==(c=0==c?"January,":c)?"February,":c)?"March,":c)?"April,":c)?"May,":c)?"June,":c)?"July,":c)?"August,":c)?"September,":c)?"October,":c)?"November,":c)&&(c="December,"),""==e.trim()?alert("Comment is empty"):(l=String(a)+" "+String(c)+" "+String(i),document.querySelector(".all__comment").insertAdjacentHTML("afterbegin",generateComment(e,t,r,l,n,value)),qualityComment())):alert("wrong email")):alert("Need to agree")});let value;const ratValue=e=>{var t;for(t of e.querySelectorAll("input"))t.checked&&(value=t.value)},validateEmail=e=>e.match(/^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/),qualityComment=()=>{var e=document.querySelectorAll(".comment_block"),t=document.querySelector(".reviews_quantity span"),r=document.querySelector(".comment_head span");t.textContent=e.length,r.textContent=e.length};qualityComment();